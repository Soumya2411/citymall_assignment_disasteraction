...
const LocationSearchInput = ({
  ...
  isInvalid = false,
  errorMessage = '',
  requireSelection = true, // New prop to enforce selection
}) => {
  ...
  const handleInputChange = (e) => {
    ...
    // If requireSelection is true and user is typing, clear selection and don't call onChange
    if (requireSelection) {
      if (selectedLocation) {
        setSelectedLocation(null);
      }
      // Don't call onChange when requireSelection is true and no location is selected
      return;
    }
    
    // Call onChange prop to update parent component (only when requireSelection is false)
    if (onChange) {
      onChange(e);
    }
